...
klines = get_historical_klines(sys.argv[1], Client.KLINE_INTERVAL_1DAY, "01 January 2017 15:00 UTC")
for lines in klines:
    #Open Time;Open Price;High Price; Low Price; Close Price; Volume; Close time
    print str(lines[0])+";"+str(lines[1])+";"+str(lines[2])+";"+str(lines[3])+";"+str(lines[4])+";"+str(lines[5])+";"+str(lines[6])
